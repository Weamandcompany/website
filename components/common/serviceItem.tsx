  ...
  return (
    <div className="relative">
      ...
      <div className="overflow-hidden relative flex">
        <Link href={link ?? ""}>
          <div className=" pb-8 pr-0 lg:px-8 lg:py-5 p-4 text-[#0C1239] shadow-lg bg-white z-[2000] relative mx-10 rounded-[8px] mb-8 lg:h-[210px] transition-all duration-500 hover:bg-[#0C1239] to-white via-[#0C1239] hover:cursor-pointer from-[#fff] hover:bg-size-200 hover:bg-right-bottom hover:text-white">
