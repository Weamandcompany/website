...
$subject1  = "New Inquiry on Weam and Comany for - '.$contactSubject.'";
...
$msg1 .= '</div>';
$msg1 .= '<p>Hello,</p>';
$msg1 .= '<p>New Inquiry on Weam and Company Website for "'.$contactSubject.'"</p>';
...
$msg1 .= '<p><strong>Comment: </strong>  '.$contactMessage.' </p>';
$msg1 .= '<p>Thank You !!! </p>';
$msg1 .= '</div>';
$msg1 .= '</body></html>';
