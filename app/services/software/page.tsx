        ...
        content: (
            <>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div>
                        <div>
                            AspenTech&apos;s product portfolio represents the
                            broadest footprint of process optimization solutions
                            in the market. The best-in-class products span
                            engineering, manufacturing, and supply chain
                            operations, enabling you to create and maintain
                            sustainable best practices while driving operational
                            excellence. We deliver Aspen Technology Software
                            solutions as the Authorized Marketing Partners,
                            which comprises a team of highly efficient Training
                            and Solution Consultants to talk you through any
                            difficulties you may encounter, offer cost-effective
                            Maintenance, Updates and Support Program keeping our
                            clients updated with the latest technology. <br />
            ...
            <>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div>
                        ...
                        <div>
                            With sector-leading comprehensive solutions, you can
                            quickly and intelligently make decisions at every
                            step of asset development while having a clear
                            picture of the performance and potential of your
                            portfolio. These solutions are relevant for:
                        </div>
                        <ul className='list-disc list-inside'>
                    ...
                    <div>
                        <div className='font-bold'>
                            Execution & Well Operations suite
                        </div>
                        <div>
                            This user-friendly software suite, which integrates
                            AFE workflows, field operations, and well master
                            data management into a simplified project delivery
                            ecosystem, lets you manage your operations with
                    ...
                    <div>
                        ...
                        <div>
                            With a single system to monitor and optimize
                            hydrocarbon production throughout the value chain,
                            you can meet production targets while reducing LOE.
                            This includes:
                        </div>
                        <ul className='list-disc list-inside'>
                    ...
                    <div>
                        ...
                        <div>
                            Using a world-class logistics solution for the
                            Energy Industry, Quorum is challenging the status
                            quo by assisting customers in reducing efforts and
                            performing better. This solution unifies the entire
                            logistics process, including personnel, cargo and
                            offshore wind, making logistics straightforward.
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='font-bold'>
                            LNG & Distribution suite
                        </div>
                        <div>
                            Simplify all LNG and pipeline operations across the
                            value chain to make faster decisions. A unified
                            version of the truth that enables planners to make
                            swift, fact-based decisions about their LNG
                    ...
                    <div>
                        ...
                        <div>
                            Simplify your measurement process and improve data
                            accuracy. Software in this suite are used for:
                        </div>
                        <ul className='list-disc list-inside'>
                    ...
                    <div>
                        ...
                        <div>
                            Streamlines complicated midstream procedures by
                            leveraging industry-leading tools for hydrocarbon
                            scheduling, accounting, transportation, and trading
                            across the value chain. This delivers solutions for
                            pipeline transaction management and Energy
                            marketing.
                        </div>
                    </div>
                </div>
...

    {
        ...
        content: (
            <>
                <div>
                    <div>
                        We offer Training and support services for Flare System
                        Design and Analysis.
                    </div>
                    <ul className='list-disc list-inside'>
                        <li>Flaresim</li>
...

    {
        ...
        content: (
            <>
                <div>
                    <div>
                        We set the standard by leading the way in Fluid Flow
                        Analysis, Pipeline and Utilities by performing pipe
                        sizing and pump selection calculations in the steady
                        state.
                    </div>
                    <ul className='list-disc list-inside'>
...

    {
        ...
        content: (
            <>
                <div>
                    <div>
                        Weam and Company Limited is a member of the SAP
                        PartnerEdge open ecosystem providing consulting
                        services. Currently, we provide comprehensive S/4HANA
                        Cutover Stabilization Support Services to the Nigerian
                        National Petroleum Company Limited (NNPCL), spanning
                    ...
                    <div>
                        Our expertise and experience enable us to support
                        complex SAP implementations and stabilization projects,
